...
| 2026-08-30 | live request issue #87 | Label-triggered attempts 1–3 through coordinator runs `33279423951`, `33279567570`, and `33280688399` | Every label passed the write-authority gate and was consumed; all three durable records exposed empty accepted-comment IDs despite preceding member comments, proving non-admitted workflow-token association metadata and requiring exact repository permission fallback for every other non-bot association before retrying |
