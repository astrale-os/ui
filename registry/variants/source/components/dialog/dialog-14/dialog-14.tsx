...
const DialogSignInDemo = () => {
  return (
    <Dialog>
      <form>
        <DialogTrigger render={<Button variant='outline' />}>Sign In</DialogTrigger>
        <DialogContent className='to-card bg-linear-to-b from-sky-100 to-40% bg-size-[100%_101%] dark:from-sky-900'>
