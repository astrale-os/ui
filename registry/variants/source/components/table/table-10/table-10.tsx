import { Table, TableBody, TableCell, TableFooter, TableHead, TableHeader, TableRow } from '@astrale-os/ui/table'
  ...
  return (
    <div className='w-full'>
      <div className='[&>div]:max-h-70 [&>div]:rounded-sm [&>div]:border'>
        <Table>
          <TableHeader>
            <TableRow className='hover:bg-muted bg-background sticky top-0'>
