...
const ButtonSocialDemo = () => {
  return (
    <div className='flex w-full max-w-56 flex-col justify-center gap-4'>
      <Button variant='outline' className='border-[#e84133] text-[#e84133]! dark:border-[#e84133]'>
        <img
      ...
      <Button variant='outline' className='border-[#0866fe] text-[#0866fe]! dark:border-[#0866fe]'>
        <img
