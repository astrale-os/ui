...
const SwitchColorsDemo = () => {
  return (
    <div className='flex items-center gap-3'>
      <Switch
        className='focus-visible:border-destructive focus-visible:ring-destructive/20 data-checked:bg-destructive dark:focus-visible:ring-destructive/40'
      ...
      />
      <Switch
        className='focus-visible:border-ring-sky-600 dark:focus-visible:border-ring-sky-400 focus-visible:ring-sky-600/20 data-checked:bg-sky-600 dark:focus-visible:ring-sky-400/40 dark:data-checked:bg-sky-400'
