...
const ScrollAreaDialogDemo = () => {
  return (
    <Dialog>
      <DialogTrigger render={<Button variant='outline' />}>Scrollable Dialog</DialogTrigger>
      <DialogContent className='flex max-h-[min(600px,80vh)] flex-col gap-0 p-0 sm:max-w-md'>
        <ScrollArea className='flex max-h-full flex-col overflow-hidden pe-1'>
            ...
            <DialogDescription render={<div className='p-6' />}>
              <div className='[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold'>
                ...
                <div className='space-y-1'>
                  ...
                  <p>
                    &rdquo;Best purchase I&apos;ve made in years. The display quality is stunning, and the battery lasts
...
export default ScrollAreaDialogDemo
