    ...
    <div className='w-full max-w-xs space-y-4'>
      <Autocomplete items={items}>
        <div className='flex flex-col items-start gap-2'>
          ...
          <AutocompleteInput id={id} placeholder='search: Docs' size='sm' />
        </div>
        <AutocompleteContent>
      ...
      <Autocomplete items={items}>
        <div className='flex flex-col items-start gap-2'>
          ...
          <AutocompleteInput id={id} placeholder='search: Docs' />
        </div>
        <AutocompleteContent>
          <AutocompleteEmpty>No items found.</AutocompleteEmpty>
          <AutocompleteList>
      ...
      <Autocomplete items={items}>
        <div className='flex flex-col items-start gap-2'>
          <Label htmlFor='with-label'>Large</Label>
          <AutocompleteInput id='with-label' placeholder='search: Docs' size='lg' />
        </div>
        <AutocompleteContent>
          <AutocompleteEmpty>No items found.</AutocompleteEmpty>
          <AutocompleteList>
