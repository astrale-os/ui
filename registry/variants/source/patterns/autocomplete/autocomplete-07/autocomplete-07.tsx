...
const AutocompleteWithTrigger = () => {
  ...
  return (
    <div className='w-full max-w-xs'>
      <Autocomplete value={value} onValueChange={setValue} items={filteredItems} itemToStringValue={item => item.value}>
        <div className='flex flex-col items-start gap-2'>
          <Label htmlFor={id}>Trigger Search</Label>
          <AutocompleteInput id={id} placeholder='Search: Docs' showTrigger />
        </div>
        <AutocompleteContent>
...
export default AutocompleteWithTrigger
