...
import { incompleteWeeklySchedule, scheduleZones } from './scheduling.fixture.js'

export default function ScheduleEditorIncompletePreview() {
  const [schedule, setSchedule] = useState<Partial<ScheduleDefinition>>(incompleteWeeklySchedule)
